...
from .serializable_config import SerializableConfig, get_workspace_hostname
...
def get_embedding_model_tokenizer(endpoint_type: str) -> Optional[dict]:
    ...
    result = EMBEDDING_MODELS_W_TOKENIZER.get(endpoint_type)
    return result.get("tokenizer") if result else None
